...
@pytest.mark.parametrize('img_path, exp', [
    (ROOT_DIR + "/tests/imgs/sber/sber_1.jpeg", {'commission': '0,00', 'recipient_phone': None, 'recipient_card_number': '8124', 'recipient_name': 'Денис Юрьевич К.', 'sender_name': 'Мурат Дмитриевич Х.', 'sender_card_number': '3714', 'check_date': '6 июня 2023 00:20:12 (МСК)', 'amount': '500,00', 'document_number': '5089428348', 'bank': 'sber'}),
    (ROOT_DIR + "/tests/imgs/sber/sber_2.jpeg", {'commission': '0,00', 'recipient_phone': None, 'recipient_card_number': '8124', 'recipient_name': 'Денис Юрьевич К.', 'sender_name': 'Юрий Александрович Л.', 'sender_card_number': '7306', 'check_date': '5 июня 2023 15:13:07 (МСК)', 'amount': '320,00', 'document_number': '4810726820', 'bank': 'sber'}),
...
@pytest.mark.parametrize('img_path, exp', [
    (ROOT_DIR + "/tests/imgs/qiwi/qiwi_1.jpeg", {'document_number': '27597008748', 'commission': '57', 'itogo': '407', 'sbp_id': None, 'recipient_phone': None, 'recipient_card_number': '8124', 'transaction_number_for_recipient': '1686030173562', 'sender_card_number': '79146519030', 'check_date': '06.06.2023 в 08:42 (МСК)', 'amount': '350', 'bank': 'qiwi'}),
    (ROOT_DIR + "/tests/imgs/qiwi/qiwi_2.png", {'commission': '0', 'itogo': '850', 'document_number': '27687761246', 'sbp_id': 'АЗ171175329490120000090011010304', 'recipient_phone': '79855458145', 'recipient_card_number': None, 'transaction_number_for_recipient': '1687283620427', 'sender_card_number': '79002841272', 'check_date': '20.06.2023 в 20:53 (МСК)', 'amount': '850', 'bank': 'qiwi'}),
])
...
@pytest.mark.parametrize('img_path, exp', [
    (ROOT_DIR + "/tests/imgs/vtb/vtb_1.jpeg", {'commission': '0', 'sbp_id': 'АЗ156164450845240000070011000503', 'recipient_phone': '+7(989)193-61-01', 'recipient_name': 'Александр Сергеевич Б', 'sender_card_number': '5267', 'sender_name': 'Олег Алексеевич М.', 'check_date': '05.06.2023, 19:44', 'amount': '500', 'bank': 'vtb'}),
])
...
@pytest.mark.parametrize('img_path, exp', [
    (ROOT_DIR + "/tests/imgs/ural/ural_1.jpg", {'commission': '0.00', 'itogo': '500.00', 'sbp_id': 'А31691227154320Р0000070011010304', 'recipient_phone': '+7 (989) 193-61-02', 'recipient_name': 'Дмитрий Станиславович И.', 'sender_name': 'БЛАХОВА ТАТЬЯНА ШИХАМОВНА', 'check_date': '18.06.2023 15:27', 'amount': '500.00', 'document_number': '123301641', 'bank': 'ural'}),
])
...
@pytest.mark.parametrize('img_path, exp', [
    (ROOT_DIR + "/tests/imgs/sov/sov_2.png", {'commission': '50', 'document_number': 'М45595373041', 'recipient_card_number': '8579', 'sender_card_number': '4020', 'check_date': '20.06.2023, 12:08', 'amount': '1000', 'bank': 'sovcom'}),
])
def test_full_sov(img_path, exp):
    res = main(img_path)
    assert res == exp